...
state_capitals.write('Springfield, Illinois\n')
state_capitals.write('Salt Lake City, Utah\n')
state_capitals.write('Raleigh, North Carolina\n')
# 5) Close the file
...
for count in range(1, books + 1):
    ...
    books_file.write("Title " + str(counter2) + ": " + book_title + '\n')
    books_file.write("Author " + str(counter2) + ": " + book_author + '\n')
...
try:
    ...
    print('Sorry, the file: "superheroes.txt" does not exist.')
