...
def main():
    # The main function simply organizes all of our
    # functions into one place and calls them.
...
def calc_average(one, two, three, four, five):
    # This function simply calculates the average
    # of the test scores.
...
def determine_grade(ave_score):
    # This function determines the grade based on the
    # average of what the user input in main and then
    # returns the correct letter grade.
    if ave_score < 60:
        return "F"
    elif ave_score < 70:
        return "D"
